...
try:
    while True:
        ...
        # Simula la ocurrencia de las actividades de ataque
        if message_count == 5:  # Cambia el número según sea necesario
            resource_development()

        if message_count == 10:  # Cambia el número según sea necesario
            acquire_infrastructure()

        if message_count == 20:  # Cambia el número según sea necesario
            develop_capabilities()

        if message_count == 30:  # Cambia el número según sea necesario
            compromise_accounts()
